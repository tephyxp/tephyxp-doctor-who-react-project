            ...
            >
              ...
              {index === 0 && (
                <div className="absolute left-0 top-[293px] w-[255px] h-[171px]">
                  ...
                  <div className="absolute left-[47px] top-[14px] w-[162px] h-[42px] bg-buttons text-black text-[32px] font-bold font-lato text-center">
                    Ver ahora
                  </div>
                </div>
              )}
              {index === 0 && (
                <div className="absolute left-[12px] top-0 text-white text-5xl font-extrabold font-lato">
                  Allons-y!
                </div>
              )}
              {/* Cambios para la segunda imagen */}
              {index === 1 && (
                <div className="absolute top-1/2 ml-52 transform -translate-x-1/2 -translate-y-1/2 text-center font-bold">
                  <p className="font-lato text-7xl text-white">The Giggle</p>
          ...
          <div className="absolute bottom-4 right-4 transform -translate-x-1/2 flex space-x-2">
            {images.map((_, index) => (
              <button
                ...
                className={`
    w-6 h-6 bg-transparent rounded-full focus:outline-none border-4 border-white 
